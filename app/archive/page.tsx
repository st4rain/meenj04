...
const ARTICLES: Article[] = [
  {
    ...
    year: "2023",
    thumbnail: "/img/archive/drawing-studies-2023/thumbnail.webp",
    images: [
      "/img/archive/drawing-studies-2023/1.webp",
      "/img/archive/drawing-studies-2023/2.webp",
    ],
  ...
  },
  {
    ...
    images: [
      "/img/archive/goblin-fire-project-draft-2025/1.webp",
      "/img/archive/goblin-fire-project-draft-2025/2.webp",
      "/img/archive/goblin-fire-project-draft-2025/3.webp",
      "/img/archive/goblin-fire-project-draft-2025/4.webp",
      "/img/archive/goblin-fire-project-draft-2025/5.webp",
    ],
  ...
  },
  {
    ...
    images: ["/img/archive/gamcheon-village-drawing-2024/main.webp"],
    label: { ko: "아카이브", en: "Archive" },
